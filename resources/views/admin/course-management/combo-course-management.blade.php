        ...
        <div class="">
            <div class="page-title">
                <div class="title_left">
                    <h3>Danh sách khóa combo học</h3>
                </div>
                                ...
                                <table class="table table-striped jambo_table bulk_action">
                                    ...
                                    @foreach($courses as $course)
                                        <tr class="even pointer">
                                            ...
                                            <td class=" ">{{$course['info']['name']}} </td>
                                            <td class=" ">{{$course['title']}} </td>
                                            <td class=" ">{{$course['status']['name']}} </td>
                        ...
                        <div class="x_panel">
                            <div class="x_content">
                                <form id="edit-info-detail-form" class="form-horizontal form-label-left" action="" method="POST" role="form">
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-md-2 col-sm-2 col-xs-12">Tiêu đề <span class="required">*</span></label>
                                        <div class="col-md-9 col-sm-9 col-xs-12">
