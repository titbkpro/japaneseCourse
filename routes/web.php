...
Route::get('/course-detail/{id}', 'User\CourseController@courseDetail')->name('course-detail');
Route::get('/course-detail/{id}/lesson/{lessonId}', 'User\CourseController@lessonDetail')->name('lesson-detail');
